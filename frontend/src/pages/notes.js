...
export default function Notes() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-200">
      ...
      <div className="flex pt-20 md:pt-24 h-screen max-w-7xl mx-auto px-0 md:px-8 gap-0 md:gap-6 pb-0 md:pb-8">

        {/* Sidebar: File Explorer */}
        <div
          className={clsx(
            "flex-col bg-zinc-900/50 overflow-hidden flex-shrink-0",
            "md:border md:border-zinc-800 md:rounded-2xl",
            "w-full md:w-80",
        ...
        <div
          className={clsx(
            "flex-1 flex-col bg-zinc-900/30 overflow-hidden relative",
            "md:border md:border-zinc-800 md:rounded-2xl",
